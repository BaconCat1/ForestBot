...
const NORMALIZED_BAD_WORDS = [...new Set(
    BAD_WORDS
...
const BAD_WORD_SET = new Set(NORMALIZED_BAD_WORDS);
...
export function censorBadWords(text: string): string {
    ...
    if (lastCopiedIndex < length) parts.push(text.slice(lastCopiedIndex));
    const censored = parts.join("");
